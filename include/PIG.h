...
definidas no arquivo Tipos.PIG.h.
Parâmetros:
...
********************************/
void SetValorFloatObjeto(int idObjeto,int indice,int valor){
...
********************************/
int GetValorIntObjeto(int idObjeto,int indice){
    return CGerenciadorObjetos::GetValorIntObjeto(idObjeto,indice);
}
...
********************************/
float GetValorFloatObjeto(int idObjeto,int indice){
    return CGerenciadorObjetos::GetValorFloatObjeto(idObjeto,indice);
}
...
void SetValorIntAnimacao(int idAnimacao,int indice,int valor){
    CGerenciadorAnimacoes::SetValorInt(idAnimacao,indice,valor);
}
...
Retorna o valor do atributo int solicitado pelo usuário.
********************************/
int GetValorIntAnimacao(int idAnimacao,int indice){
    return CGerenciadorAnimacoes::GetValorInt(idAnimacao,indice);
}
...
void SetValorFloatAnimacao(int idAnimacao,int indice,float valor){
    CGerenciadorAnimacoes::SetValorFloat(idAnimacao,indice,valor);
}
...
Retorna o valor do atributo float solicitado pelo usuário.
********************************/
float GetValorFloatAnimacao(int idAnimacao,int indice){
    return CGerenciadorAnimacoes::GetValorFloat(idAnimacao,indice);
}
...
/********************************
A função ResumeAudio() é responsável por continuar a tocar um áudios pausado.
Parâmetro:
idAudio (entrada, passagem por valor): indentificador do áudio.
********************************/
...
/********************************
A função StopAudio() é responsável por parar um áudios pausado ou tocando.
Parâmetro:
idAudio (entrada, passagem por valor): indentificador do áudio.
********************************/
